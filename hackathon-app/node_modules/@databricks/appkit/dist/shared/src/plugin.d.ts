 ...
 */
interface PluginManifest<TName extends string = string> extends Omit<PluginManifest$1, "name" | "config" | "$schema" | "resources" | "displayName" | "description" | "author" | "version" | "repository" | "keywords" | "license" | "onSetupMessage" | "hidden" | "stability"> {
  name: TName;
  resources: {
